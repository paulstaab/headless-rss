...
| TC-RUST-095 | Rust LLM summary prompt constraints | Build the Rust article-summary payload. | The prompt requests a 2-3 sentence newspaper-style summary in the same language as the article and keeps the structured `summary` response contract. |
