...
### Items
- **GET `/items`** – Retrieves items. Query parameters: `batchSize` (default `-1`), `offset` (`0`), `type` (`0` feed, `1` folder, `2` starred, `3` all), `id` (`0`), `getRead` (`true`), `oldestFirst` (`false`), `lastModified` (`0`). Returns `{ "items": [ { "id", "title", "body", "author", "feedId", "guid", "guidHash", "pubDate", "updatedDate", "lastModified", "url", "unread", "starred", ... } ] }`.
